...
public class LDAPTest {
    ...
    public static void main(String[] args) throws NamingException {
        ...
        final String ldapAdServer = "ldap://cscpanbld001:390";
        final String ldapSearchBase = "ou=employees,o=bpo";
        
        final String ldapUsername = "tali20";
        final String ldapPassword = "pano";
    ...
    public SearchResult findAccountByAccountName(DirContext ctx, String ldapSearchBase, String accountName) throws NamingException {
        ...
        String searchFilter = "(&(cn=*)(objectclass=groupOfUniqueNames))";

        SearchControls searchControls = new SearchControls();
        searchControls.setSearchScope(SearchControls.SUBTREE_SCOPE);

        NamingEnumeration results = ctx.search("ou=wma-pano,ou=groups,o=bpo", searchFilter, searchControls);
